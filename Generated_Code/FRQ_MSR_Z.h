...
#define __BWUserType_FRQ_MSR_Z_TCapturedValue
  #define FRQ_MSR_Z_TCapturedValue word /*  Captured value, unsigned integer value. Bit-width of the type depends on the width of selected timer. */
#endif
...
__interrupt void FRQ_MSR_Z_Interrupt(void);
/*
** ===================================================================
