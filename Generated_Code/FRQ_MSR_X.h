...
/* PUBLISHED CONSTANTS */
#define FRQ_MSR_X_PRESCALER_VALUE           0x02U /* Prescaler value of the timer in high speed mode */
#define FRQ_MSR_X_COUNTER_INPUT_CLOCK_HZ    0x00C00000LU /* Initial counter input clock frequency [Hz] */
#define FRQ_MSR_X_TIMER_INPUT_CLOCK         0x01800000LU /* Deprecated, Initial timer input clock frequency [Hz] */
#define FRQ_MSR_X_PRESCALER_VALUE_HIGH      0x02U /* Prescaler value of the timer in high speed mode */
#define FRQ_MSR_X_COUNTER_INPUT_CLOCK_HZ_HIGH 0x00C00000LU /* Counter input clock frequency in high speed mode [Hz] */
