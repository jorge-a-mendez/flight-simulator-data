...
volatile word FRQ_MSR_Y_CntrState;     /* Content of counter */
...
*/
/*
byte FRQ_MSR_Y_Reset(word *Value)

**  This method is implemented as a macro. See FRQ_MSR_Y.h file.  **
*/
...
*/
/*
byte FRQ_MSR_Y_GetCaptureValue(FRQ_MSR_Y_TCapturedValue *Value)
...
void FRQ_MSR_Y_Init(void)
{
  ...
  FRQ_MSR_Y_CntrState = 0x00U;         /* Clear variable */
  /* TPM1C2SC: CH2F=0,CH2IE=1,MS2B=0,MS2A=0,ELS2B=0,ELS2A=1,??=0,??=0 */
  setReg8(TPM1C2SC, 0x44U);            /* Enable both interrupt and capture function */ 
}
