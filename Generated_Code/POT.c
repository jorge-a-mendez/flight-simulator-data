...
volatile word POT_OutV;                /* Sum of measured values */
...
ISR(POT_Interrupt)
{
  ...
  ((TWREG volatile*)(&POT_OutV))->b.high = ADCRH; /* Save measured value */
  ((TWREG volatile*)(&POT_OutV))->b.low = ADCRL; /* Save measured value */
  /*lint -restore Enable MISRA rule (11.4) checking. */
  OutFlg = TRUE;                       /* Measured values are available */
  POT_OnEnd();                         /* Invoke user event */
...
byte POT_GetValue(void *Values)
{
  ...
  *(word*)Values = POT_OutV;           /* Save measured values to the output buffer */
  return ERR_OK;                       /* OK */
}
...
byte POT_GetValue16(word *Values)
{
  ...
  *Values = (word)((POT_OutV) << 4);   /* Save measured values to the output buffer */
  return ERR_OK;                       /* OK */
}
